...
- 生成时间：2026-09-12T04:12:53+0800
- 最大验证级别：L5
- 单元总数：84
- **K1 执行率：54.8%**（PASS 46 / 环境阻塞 7 / 孤儿依赖 9 / 失败 22 / 未执行 0）
...
| ✅ PASS | `paper2skills-vault/02-A_B实验/Skill-Multi-Armed-Bandit.md#stitched(1块)` | — | 全部通过 |
...
| ✅ PASS | `paper2skills-vault/05-推荐系统/Skill-Matrix-Factorization.md#stitched(1块)` | — | 全部通过 |
...
| ✅ PASS | `paper2skills-vault/05-推荐系统/Skill-Session-Based-Recommendation-SR-GNN.md#stitched(1块)` | — | 全部通过 |
| ✅ PASS | `paper2skills-vault/06-增长模型/Skill-Cold-Start-Product-Recommendation.md#stitched(1块)` | — | 全部通过 |
| ❌ FAIL | `paper2skills-vault/06-增长模型/Skill-Customer-Churn-Prediction.md#stitched(1块)` | L4_SMOKE | [block1] 运行期错误 阻塞在 line 4 |
...
| ❌ FAIL | `paper2skills-vault/07-NLP-VOC/00-知识库-Skill卡片/Skill-InstructUIE-Unified-Information-Extraction.md#stitched(1块)` | L3_IMPORT | import 时崩溃 |
| ❌ FAIL | `paper2skills-vault/07-NLP-VOC/00-知识库-Skill卡片/Skill-LLM-Personalized-Marketing-Copy-Generation.md#stitched(2块)` | L3_IMPORT | import 时崩溃 |
...
| ❌ FAIL | `paper2skills-vault/07-NLP-VOC/00-知识库-Skill卡片/Skill-REVISION-无点击意图挖掘.md#stitched(2块)` | L3_IMPORT | import 时崩溃 |
...
| ❌ FAIL | `paper2skills-vault/07-NLP-VOC/00-知识库-Skill卡片/Skill-Spiral-of-Silence-沉默少数派挖掘.md#stitched(2块)` | L3_IMPORT | import 时崩溃 |
...
| ❌ FAIL | `paper2skills-vault/07-NLP-VOC/00-知识库-Skill卡片/Skill-VOC-Proxy-NPS-AIPL-统一萃取引擎.md#stitched(2块)` | L3_IMPORT | [block1] import 时崩溃 |
...
| ❌ FAIL | `paper2skills-vault/08-知识图谱/Skill-HGT-Heterogeneous-Graph-Transformer.md#stitched(2块)` | L3_IMPORT | import 时崩溃 |
...
| ✅ PASS | `paper2skills-vault/08-知识图谱/Skill-Knowledge-Graph-for-Skills-Management.md#stitched(1块)` | — | 全部通过 |
| ✅ PASS | `paper2skills-vault/08-知识图谱/Skill-Multilingual-NER-Universal-v2.md#stitched(1块)` | — | 全部通过 |
| 🟡 ENV_BLOCKED | `paper2skills-vault/09-DataAgent-LLM/Skill-Argos-Agentic-Anomaly-Detection.md#stitched(1块)` | L3_IMPORT | [block1] 缺第三方依赖/凭证: openai |
