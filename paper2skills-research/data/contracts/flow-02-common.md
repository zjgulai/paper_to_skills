# FLOW-02 契约撰写 · 公共材料（所有批次共用）

> 本文件由 `build_contract_workpack.py` 生成，**不要手改**（改了就与图谱脱钩）。
> 逐份契约的规格在 `flow-02-batch-NN.md`。
...
- **FLOW-02** 的能力贡献岗位 26 个：AGT-001 衡远·经营目标与资源统筹、AGT-002 枢衡·场景自主编排与异常协调、AGT-006 听澜·消费者需求与VOC研究、AGT-007 望野·市场竞争与机会研究、AGT-008 拓新·产品组合与新品孵化、AGT-009 定形·产品定义与商业立项、AGT-010 映物·工业设计与用户体验、AGT-011 砺器·硬件结构与材料工程、AGT-012 灵枢·软件算法与应用生态、AGT-013 求证·产品验证与研发项目、AGT-014 择源·OEM供应商开发与协同、AGT-018 质守·生产协同与质量控制、AGT-021 北辰·Amazon业务经营、AGT-024 拓域·其他平台与新市场经营、AGT-028 译境·本地化与市场适配、AGT-029 立言·品牌战略与传播、AGT-030 叙事·内容与创意策划、AGT-031 绘影·视觉视频与素材生产、AGT-033 结伴·达人与联盟合作、AGT-035 试真·增长实验与增量评估、AGT-038 回声·体验洞察与质量反馈、AGT-039 同行·用户教育与会员社区、AGT-041 守金·经营财务与资金、AGT-043 律衡·法务与知识产权、AGT-044 安界·产品合规与隐私、AGT-048 积知·知识技能与Playbook治理
- 8 个阶段（格类型：M = 算法模型接入点，R/D = 只放判据与契约，**不得**说成算法接入）：

| STG | 阶段 | 格 | 业务步骤 | 标准产物（**逐字引用这个名字**） |
|---|---|---|---|---|
| STG-01 | 信号接收 | D | 接收需求证据、使用问题或产品组合缺口 | 新品机会信号 |
| STG-02 | 范围确定与Case创建 | R | 确定用户问题、市场、产品范围、验证目标与停止条件 | 新品验证Case Charter |
| STG-03 | 上下文装配 | D | 装配需求、竞品、产品定义、工程、OEM、质量、合规和验证能力 | FLOW-02 Context Manifest |
| STG-04 | 证据收集与诊断 | M | 区分事实与假设，核对VOC、替代方案、技术/OEM/质量/准入证据 | 机会与可行性诊断 |
| STG-05 | 方案与标准产物 | M | 形成商业假设、产品定义和验证方案 | 新品验证证据包 |
| STG-06 | Assurance接收门禁 | R | 检查可证伪性、实物/专业证据来源、合规、资源与混杂因素 | FLOW-02 Assurance Decision |
| STG-07 | 受控动作 | D | 发起受控外部验证Intent或记录无需动作；不得把模型判断当实物回执 | 验证尝试或无动作记录 |
| STG-08 | 结果核验、关闭与异步学习 | M | 核对验证结果并形成继续、转向或停止结论 | 新品验证关闭记录 |
...
- 阶段产物：新品机会信号 · 新品验证Case Charter · FLOW-02 Context Manifest · 机会与可行性诊断 · 新品验证证据包 · FLOW-02 Assurance Decision · 验证尝试或无动作记录 · 新品验证关闭记录
...
- 口径与主数据：AGT-045 指标契约与主数据、AGT-046 的质量状态/来源/新鲜度、
  `业务规则字典`、`标签分配结果表`
- **本 FLOW 的手册 = PB-002**（`docs/06-playbooks/PLAYBOOKS.md`；FLOW↔PB 的对应见 `FLOW-CATALOG.md`）
...
3. 同一句话在本 FLOW 的 73 份里重复出现 ⇒ 视为未撰写。
