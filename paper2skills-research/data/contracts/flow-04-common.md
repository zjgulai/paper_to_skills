# FLOW-04 契约撰写 · 公共材料（所有批次共用）

> 本文件由 `build_contract_workpack.py` 生成，**不要手改**（改了就与图谱脱钩）。
> 逐份契约的规格在 `flow-04-batch-NN.md`。
...
- **FLOW-04** 的能力贡献岗位 20 个：AGT-002 枢衡·场景自主编排与异常协调、AGT-007 望野·市场竞争与机会研究、AGT-009 定形·产品定义与商业立项、AGT-019 通途·跨境物流与关务、AGT-021 北辰·Amazon业务经营、AGT-022 觅位·Amazon商品与搜索运营、AGT-023 自航·独立站经营与转化、AGT-024 拓域·其他平台与新市场经营、AGT-025 联商·零售渠道与B2B拓展、AGT-027 守店·店铺账号健康与规则、AGT-028 译境·本地化与市场适配、AGT-029 立言·品牌战略与传播、AGT-030 叙事·内容与创意策划、AGT-031 绘影·视觉视频与素材生产、AGT-033 结伴·达人与联盟合作、AGT-036 安心·售前服务与购买指导、AGT-042 合账·税务与跨境实体协作、AGT-043 律衡·法务与知识产权、AGT-044 安界·产品合规与隐私、AGT-050 门卫·信息安全与权限
- 8 个阶段（格类型：M = 算法模型接入点，R/D = 只放判据与契约，**不得**说成算法接入）：

| STG | 阶段 | 格 | 业务步骤 | 标准产物（**逐字引用这个名字**） |
|---|---|---|---|---|
| STG-01 | 信号接收 | D | 接收新市场、平台、店铺或商品上线请求 | 市场进入信号 |
| STG-02 | 范围确定与Case创建 | R | 确定市场、渠道账号、商品集合、时间窗和进入成功条件 | 市场进入Case Charter |
| STG-03 | 上下文装配 | D | 装配市场机会、准入、IP/合规、本地化、履约、售后、结算和品牌能力 | FLOW-04 Context Manifest |
| STG-04 | 证据收集与诊断 | M | 核对机会、商品主数据、证据、宣称、税务、履约、售后和账号准备 | 市场进入诊断 |
| STG-05 | 方案与标准产物 | M | 形成准入证据矩阵、本地化内容和市场进入包 | 市场进入包 |
| STG-06 | Assurance接收门禁 | R | 检查适用策略、市场规则、账号主体、内容、履约和结算准备 | FLOW-04 Assurance Decision |
| STG-07 | 受控动作 | D | 提交受控上架Intent或NoActionRecord；具体市场和接口待配置 | 上架尝试或无动作记录 |
| STG-08 | 结果核验、关闭与异步学习 | M | 核对逐商品上线回执、异常和初步经营结果 | 市场进入关闭记录 |
...
- 阶段产物：市场进入信号 · 市场进入Case Charter · FLOW-04 Context Manifest · 市场进入诊断 · 市场进入包 · FLOW-04 Assurance Decision · 上架尝试或无动作记录 · 市场进入关闭记录
...
- 口径与主数据：AGT-045 指标契约与主数据、AGT-046 的质量状态/来源/新鲜度、
  `业务规则字典`、`标签分配结果表`
- **本 FLOW 的手册 = PB-004**（`docs/06-playbooks/PLAYBOOKS.md`；FLOW↔PB 的对应见 `FLOW-CATALOG.md`）
