...
> ### 📌 尚未开始
>
> **Y1–Y5（甲类卡片缺陷 Top5）**、**Z1–Z4（档案卫生 / registry）**、**§4 待业务方决策 4 问** ——
> 全部按原计划待执行。X5 还留下 3 个**已登记未修**项（见 CLAUDE.md：
> `provenance_audit` 的「剥尾部参考区」实为 `text[:12000]` **截断**；
> **11 张卡 frontmatter 用 `name:` 而非 `title:`**；`--pdf` 路径版本恒 `unknown`）。
