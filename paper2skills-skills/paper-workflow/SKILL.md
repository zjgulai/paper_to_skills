...
- **`<REPO_ROOT>/paper2skills-vault/07-资源库/MasterPrompt.md`**

### 关键词库

论文搜索关键词库：
- **`<REPO_ROOT>/paper2skills-vault/07-资源库/关键词库.md`**

### 已有 Skill 卡片

已生成的 Skill 卡片：
- **`<REPO_ROOT>/paper2skills-vault/01-因果推断/Skill-Uplift-Modeling.md`**

### 代码模板

Python 代码模板：
- **`<REPO_ROOT>/paper2skills-code/`**
