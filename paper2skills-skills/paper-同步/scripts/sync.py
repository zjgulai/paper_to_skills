...
# 配置路径
# 仓库根目录：优先环境变量 PAPER2SKILLS_ROOT，否则由脚本位置反推
# 脚本位于 <repo>/paper2skills-skills/paper-同步/scripts/sync.py → parents[3] 即仓库根
...
# 领域映射（与 CLAUDE.md → Domain Mapping 对齐）
DOMAINS = {
