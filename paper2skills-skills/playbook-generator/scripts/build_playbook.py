...
from builders.agents_builder import render_agents_page as _render_agents_page, render_agent_report_page as _render_agent_report_page  # noqa: E402


def render_agents_page(skill_lookup: dict[str, "PlaybookSkill"]) -> str:  # noqa: F811
    return _render_agents_page(skill_lookup, _html_page=html_page)


def render_agent_report_page() -> str:  # noqa: F811
    return _render_agent_report_page(_html_page=html_page)
...
from builders.chat_diagnostic_builder import render_diagnostic_page as _render_diagnostic_page, render_chat_page as _render_chat_page, build_chat_page_js as _build_chat_page_js, build_search_js as _build_search_js  # noqa: E402


def render_diagnostic_page(skill_count: int, build_ts: str) -> str:  # noqa: F811
    return _render_diagnostic_page(skill_count, build_ts)


def render_chat_page(nav: str = "", skill_count: int = 0) -> str:  # noqa: F811
    return _render_chat_page(nav=nav, skill_count=skill_count)


def build_chat_page_js() -> str:  # noqa: F811
    return _build_chat_page_js()


def build_search_js() -> str:  # noqa: F811
    return _build_search_js()
