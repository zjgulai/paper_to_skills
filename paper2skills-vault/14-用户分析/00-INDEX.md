...
| [Skill-LACA-CrossLingual-ABSA](./Skill-LACA-CrossLingual-ABSA.md) | 已萃取 P0 | arXiv:2508.09515 (ACL 2025) | 零样本跨语言 ABSA(德/法/西/日)/WF-C+WF-E 双用 |
...
- 已萃取:**6**(2 基础 + 4 ABSA 闭环)
- 规划待萃取:5
- 服务工作流:**WF-E Review 监控 + WF-C 客服分诊**(双工作流)
