...
### 前置技能
- [Skill-Feature-Engineering](../12-ML基础/[[Skill-Feature-Engineering]].md) — 实验前需要明确指标定义与维度切分（特征化）

### 延伸技能
- [Skill-AB-Test-Result-Interpretation](../02-A_B实验/[[Skill-AB-Test-Result-Interpretation]].md) — 实验设计后接结果解读
- [Skill-Power-Analysis-Sample-Size](../02-A_B实验/[[Skill-Power-Analysis-Sample-Size]].md) — 实验设计的核心步骤之一是样本量估算

### 可组合
- [Skill-Multi-Armed-Bandit](../02-A_B实验/[[Skill-Multi-Armed-Bandit]].md) — 传统 A/B 与 MAB 是流量分配的两种范式
- [Skill-Thompson-Sampling-MAB](../02-A_B实验/[[Skill-Thompson-Sampling-MAB]].md) — 贝叶斯化 A/B 与 Thompson 采样互补
