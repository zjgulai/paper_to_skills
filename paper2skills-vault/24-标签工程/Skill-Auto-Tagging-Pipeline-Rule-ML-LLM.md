...
**三轨验证** | 成本轨：月均成本800元（采用混合方案：规则引擎+轻量LLM，API调用400元/月，人工标注4小时/月=600元，总计1000元/月），相比纯LLM方案降低50% | 合规轨：满足《GB/T 9752商品分类与编码》和平台内部标签体系，标签溯源可追踪，审计合规性98% | 风险轨：规则维护成本高（概率20%/季度需更新），新品类冷启动准确率仅72%（概率25%首月），人工标注质量不稳定导致训练数据偏差（概率10%）
