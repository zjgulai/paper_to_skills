...
**三轨验证** | 成本轨：FBA备货成本月均8,500元（仓储费2,500元/月+头程物流3,200元/月+尾程配送2,000元/月+系统管理800元/月），人工投入12小时/月用于库存预测和补货决策，缺货率从12%降至3%后年化增收45万元，ROI周期约2.8个月 | 合规轨：符合《跨境电商进出口商品质量安全监督管理办法》和亚马逊FBA合规要求，婴儿奶粉需提供营养成分检测报告、原产地证明和进口许可证，建议建立供应商审核档案并每季度更新 | 风险轨：供应链中断风险（概率15%，如原产地政策变化）、库存积压风险（概率8%，季节性需求波动）、汇率波动风险（概率25%，影响头程成本）、FBA仓储费上涨风险（概率12%，年均涨幅3-5%）
