...
**三轨验证** | 成本轨：月均2800元（FDA认证咨询1500元/月+CE标志申报800元/月+系统监控500元/月），人工投入12小时/月（合规专员） | 合规轨：母婴产品符合FDA 21 CFR Part 111（膳食补充剂）和CE MDR医疗器械指令2017/745，通过自动化合规图谱监控可确保上架前100%覆盖关键法规要点，结论：可合规上架 | 风险轨：主要风险包括：(1)FDA新增警告信风险-概率8%/季度；(2)CE标志虚假声明被查处-概率3%/年；(3)产品成分变更导致重新认证-概率15%/年

**三轨验证** | 成本轨：月均1200元（自建合规监控系统600元/月+第三方检测费400元/月+数据维护200元/月），人工投入6小时/月（兼职合规审核） | 合规轨：通过Regulatory Graph实时监控FDA/CE政策更新，建立动态合规基线库，覆盖母婴产品禁限用物质清单（如邻苯二甲酸盐、BPA等），结论：满足基础合规要求但需定期人工审查 | 风险轨：主要风险包括：(1)监控系统漏报新规-概率12%/季度；(2)产品标签不符合当地语言要求-概率20%/年；(3)跨境物流中产品损坏导致质量问题-概率6%/年
