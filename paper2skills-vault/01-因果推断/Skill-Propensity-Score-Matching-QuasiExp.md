...
**三轨验证** | 成本轨：PSM模型构建月均成本3,500元（数据清洗2小时/周、倾向得分计算8小时/月、匹配验证6小时/月，人工成本按¥150/小时计），年化成本42,000元；工具成本月均500元（统计软件R/Python许可+云计算资源）；总年化成本¥48,000元 | 合规轨：符合《电商法》第十七条关于促销信息披露要求；满足《反不正当竞争法》第八条，因果推断结论需标注

**三轨验证** | 成本轨：简化PSM方案月均成本1,800元（倾向得分计算4小时/月、基础匹配3小时/月，人工成本¥150/小时），年化成本21,600元；使用开源工具（MatchIt R包）降低软件成本至月均100元；总年化成本¥23,200元 | 合规轨：满足《电商法》基本要求，因果推断结论需在营销物料中标注
