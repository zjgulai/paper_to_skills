...
**三轨验证** | 成本轨：工具成本月均1200元（IV统计软件许可费800元+数据清洗人工8小时×50元/小时=400元），年化14400元；人工成本月均3000元（因果分析师1人×0.5FTE），年化18000元；总年化成本32400元，占42万元ROI的7.7% | 合规轨：符合《电商平台促销归因指南》要求，IV方法满足因果识别的单调性假设和排他性限制条件，需在报告中披露工具变量选择依据（如：选择竞品促销频率作为IV，排他性证明需单独附件）；符合跨境电商数据隐私合规（GDPR/CCPA涉及个人购买数据需脱敏处理） | 风险轨：(1)IV有效性风险概率35%—工具变量与混淆因子相关导致估计偏差，需Sargan检验p>0.05；(2)样本量不足风险概率20%—婴儿推车SKU有限，月均订单<500单时弱IV问题，F统计量<10；(3)模型假设违反风险概率25%—线性假设不成立，需分段回归验证
