...
| [Skill-Memory-as-Action](./Skill-Memory-as-Action.md) | 已萃取 P2 | MemAct (arxiv:2510.12635) | Memory 操作嵌入 policy |
...
| [Skill-Orchestration-Trace-RL](./Skill-Orchestration-Trace-RL.md) | 已萃取 P2 | RL via Orchestration Traces (arxiv:2605.02801) | 用 trace 训 RL 优化编排决策 |
| [Skill-Task-Adaptive-Topology](./Skill-Task-Adaptive-Topology.md) | 已萃取 P2 | AdaptOrch (arxiv:2602.16873) | 动态拓扑(比 static 提升 12-23%) |
...
| [Skill-SLM-Tool-Calling-Optimization](./Skill-SLM-Tool-Calling-Optimization.md) | 已萃取 P2 | SLM Tool Calling (arxiv:2512.15943) | 客服/工单分类成本优化 |
