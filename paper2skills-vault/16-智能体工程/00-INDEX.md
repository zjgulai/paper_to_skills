...
| 技能 | 状态 | 论文 | 业务场景 |
|------|------|------|---------|
| Skill-Auto-Skill-Synthesis | 待萃取 P0 | SkillForge (SIGIR 2026, arxiv:2604.08618) | 从客服历史对话自动生成 Skill |
| Skill-Skill-Lifecycle-Design | 待萃取 P1 | SoK Agentic Skills (arxiv:2602.20867) | Skill 卡设计哲学与生命周期 |
