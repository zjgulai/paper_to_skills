...
def main():
    ...
    dict_path = Path(__file__).parent.parent.parent / "04-输出结果/tag_dictionary_v3.4_filled.xlsx"
    ...
    audit_path = Path(__file__).parent.parent.parent / "04-输出结果/phase2_9_audit.json"
