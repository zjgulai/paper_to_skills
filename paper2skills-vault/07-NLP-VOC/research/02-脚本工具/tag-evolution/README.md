...
**产出**:
- `04-outputs/tag_gap_analysis/zero_label_by_category.json` — 各品类零标签率
- `04-outputs/tag_gap_analysis/zero_label_samples.csv` — 零标签样本
...
- 生成函数: 74 个
- 代码行数: ~1,200 行
- 输出: `04-outputs/alchemist_label_functions.py`
...
v3.5标签字典新增20个通用标签，策略包/主责部门/优先级等字段标记为【待填写】，需业务侧补充。
...
| 文件 | 说明 |
|------|------|
| `04-outputs/tag_dictionary_v3.5_final.xlsx` | **最终标签字典（503标签）** |

### 打标结果

| 文件 | 说明 |
|------|------|
| `04-outputs/unified_labeling/phase3_p3_labeled.jsonl` | 最终完整打标结果（364,569条） |

### Label Functions

| 文件 | 说明 |
|------|------|
| `04-outputs/alchemist_label_functions.py` | 74个ALCHEmist标注规则 |
| `04-outputs/zendesk_service_label_functions.py` | 10个Zendesk售中售后标签 |
| `02-scripts/tag-evolution/general_tag_labeler.py` | 20个通用标签（含多语言） |

### 审计报告

| 文件 | 说明 |
|------|------|
| `04-outputs/phase3_final_summary.md` | Phase 3 最终综合报告 |
| `04-outputs/phase3_p3_audit.json` | P3 审计 |
| `04-outputs/phase3_p2_audit.json` | P2 审计 |
| `04-outputs/phase3_p1_audit.json` | P1 审计 |
| `04-outputs/phase2_9_audit.json` | 标签字典验证 |
