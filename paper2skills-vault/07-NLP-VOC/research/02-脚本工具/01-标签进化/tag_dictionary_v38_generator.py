...
def derive_owner_dept(tag_theme: str) -> tuple[str, str, str]:
    """推导主责部门、协同部门、业务动作"""
    mapping = {
        "产品体验负面": ("产品中心", "全球客服中心", "产品中心：优化产品体验，降低负面反馈率"),
        "客服售后": ("全球客服中心", "电商运营部", "全球客服中心：建立售后工单快速响应机制"),
        "产品质量缺陷": ("品质管理中心", "产品中心; 仓储物流部", "品质管理中心：建立缺陷闭环追踪，推动供应商改进"),
        "品牌提及": ("品牌市场中心", "品牌市场中心", "品牌市场中心：监测品牌声量，分析竞品对比趋势"),
    }
    return mapping.get(tag_theme, ("产品中心", "通用", "产品中心：持续监控标签覆盖率"))
