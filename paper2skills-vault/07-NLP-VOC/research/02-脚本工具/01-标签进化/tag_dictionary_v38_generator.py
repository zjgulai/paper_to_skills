...
def derive_owner_dept(tag_theme: str) -> tuple[str, str, str]:
    """推导主责部门、协同部门、业务动作"""
    mapping = {
        "产品体验负面": ("产品中心/品线", "用户体验部", "产品中心/品线：优化产品体验，降低负面反馈率"),
        "客服售后": ("全球客服与体验中心", "运营部", "全球客服与体验中心：建立售后工单快速响应机制"),
        "产品质量缺陷": ("品控部", "产品中心/品线; 供应链部", "品控部：建立缺陷闭环追踪，推动供应商改进"),
        "品牌提及": ("品牌市场中心", "品牌运营部", "品牌市场中心：监测品牌声量，分析竞品对比趋势"),
    }
    return mapping.get(tag_theme, ("产品中心/品线", "通用", "产品中心/品线：持续监控标签覆盖率"))
