...
sequenceDiagram
    ...
    rect rgb(227, 242, 253)
        ...
        SS->>PG: SELECT * FROM v_dept_topic_summary<br/>WHERE dept_owner='产品中心'<br/>ORDER BY hit_count DESC LIMIT 10
        PG-->>SS: 10 行结果
    ...
    rect rgb(200, 230, 201)
        ...
        SS->>PG: SELECT * FROM v_dept_topic_summary<br/>WHERE dept_owner='产品中心'<br/>  AND polarity='负向'<br/>ORDER BY hit_count DESC LIMIT 10
        PG-->>SS: 10 行（不同结果）
