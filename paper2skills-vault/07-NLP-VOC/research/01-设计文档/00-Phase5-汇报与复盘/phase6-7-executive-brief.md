...
3. **没有人能看到结果**：364K 条打过标的数据躺在 jsonl 文件里，没有任何"按部门 / 按维度切片"的能力——业务部门要看一份产品中心/品线的 top-10 问题，得让算法同事写 SQL
...
| 拿到一份"全球客服与体验中心 negative top 10"要多久 | 找算法同事写 SQL，2-3 小时 | **自己点击 dashboard，10 秒** |
...
**用户体验**：业务部门同事打开 `http://localhost:8088/dashboard/3/`（产品中心/品线看板），点击「情感极性 = 负向」，**3 秒内** 看到「延迟 12.3k / 尺码小 4.7k / 使用体验差 3.4k」三个最痛的负向标签。
...
| BI 看板真的能交互吗？ | [phase7_d4_progress_report.md §四](../../04-输出结果/03-审计报告/phase7_d4_progress_report.md) Playwright 实测：产品中心/品线 polarity=负向 → top-10 完全换面 |
