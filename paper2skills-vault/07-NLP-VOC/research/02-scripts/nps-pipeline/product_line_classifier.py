...
def analyze_data_sources():
    ...
    OUTPUT_BASE = Path("/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/04-outputs/labeling-latest")

    configs = {
        "amazon": ("/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/03-data-assets/高质量数据源/amazon_voc_200k_balanced.csv", "Content"),
        "trustpilot": ("/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/03-data-assets/高质量数据源/trustpilot_voc_100k_balanced.csv", "Content"),
        "reddit": ("/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/03-data-assets/高质量数据源/reddit_voc_sampled.csv", "Content"),
        "zendesk": ("/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/03-data-assets/高质量数据源/zendesk_momcozy_voc_sampled.csv", "Content"),
    }
