...
SOURCE_CONFIGS: dict[str, SourceConfig] = {
    "amazon": SourceConfig(
        name="amazon",
        csv_path="/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/03-data-assets/高质量数据源/amazon_voc_200k_balanced.csv",
        text_col="Content",
        rating_col="Rating",
        id_col="Asin",
        spu_col="Asin",
    ...
    "trustpilot": SourceConfig(
        name="trustpilot",
        csv_path="/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/03-data-assets/高质量数据源/trustpilot_voc_100k_balanced.csv",
    ...
    "reddit": SourceConfig(
        name="reddit",
        csv_path="/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/03-data-assets/高质量数据源/reddit_voc_sampled.csv",
    ...
    "zendesk": SourceConfig(
        name="zendesk",
        csv_path="/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/03-data-assets/高质量数据源/zendesk_momcozy_voc_sampled.csv",
        text_col="_review_text",
        rating_col="星级评分",
        id_col="工单号",
        spu_col="SPU名称",
...
TAG_DICT_PATH = "/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/04-outputs/labeling-latest/SGCS_VOC标签字典_V3.3.1_universal.xlsx"
OUTPUT_BASE = "/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/04-outputs/labeling-latest"
