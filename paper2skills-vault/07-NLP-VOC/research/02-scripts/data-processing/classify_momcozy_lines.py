...
if __name__ == "__main__":
    input_csv = Path("/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/00-archived/runtime-outputs/sampled/momcozy_sampled_full.csv")
    output_dir = Path("/Users/pray/project/paper_to_skills/paper2skills-vault/07-NLP-VOC/research/00-archived/runtime-outputs/classified")
