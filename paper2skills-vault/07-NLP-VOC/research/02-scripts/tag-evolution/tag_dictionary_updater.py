...
def main():
    ...
    base_dir = Path(__file__).parent.parent.parent / "03-data-assets/原种子标签"
    output_dir = Path(__file__).parent.parent.parent / "04-outputs"
    ...
    candidates_path = (
        ...
        / "04-outputs/tag_gap_analysis/candidate_tags_filtered.json"
    )
