...
def main():
    ...
    base_dir = Path(__file__).parent.parent.parent / "04-outputs"
    ...
    outputs = [
        ("统一打标结果", "04-outputs/unified_labeling/phase1_5_all_sources_labeled_final.jsonl", "364,569 条 VOC 的完整标签"),
        ("标签字典 v3.4", "04-outputs/tag_dictionary_v3.4_filled.xlsx", "483 个标签（409 原有 + 74 新增）"),
        ("ALCHEmist Label Functions", "04-outputs/alchemist_label_functions.py", "74 个可审计标注规则"),
        ("人工审核清单", "04-outputs/tag_gap_analysis/manual_review_checklist.csv", "1 个候选标签待审核"),
        ("零标签样本", "04-outputs/tag_gap_analysis/zero_label_samples.csv", "9,486 条零标签 VOC"),
        ("缺口分析报告", "04-outputs/tag_gap_analysis/gap_analysis.json", "112 个品类缺口"),
    ]
