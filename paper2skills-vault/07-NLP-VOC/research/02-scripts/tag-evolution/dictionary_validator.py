...
def main():
    ...
    dict_path = Path(__file__).parent.parent.parent / "04-outputs/tag_dictionary_v3.4_filled.xlsx"
    ...
    audit_path = Path(__file__).parent.parent.parent / "04-outputs/phase2_9_audit.json"
