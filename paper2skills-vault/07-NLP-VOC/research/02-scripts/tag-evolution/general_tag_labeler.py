...
GENERAL_TAGS = [
    ...
    },
    {
        ...
        "negation_keywords": ["slow delivery", "late delivery", "delayed shipping", "never arrived"],
    },
    {
        "tag_id": "TAG_GEN_C001",
        ...
        "negation_keywords": ["terrible service", "awful service", "rude staff", "no response"],
    },
    {
        "tag_id": "TAG_GEN_P001",
...
def main():
    ...
    input_path = Path("04-outputs/unified_labeling/phase3_p2_labeled.jsonl")
    output_path = Path("04-outputs/unified_labeling/phase3_p3_labeled.jsonl")
    ...
    audit_path = Path("04-outputs/phase3_p3_audit.json")
