...
def extract_zero_labels():
    ...
    input_path = Path(__file__).parent.parent.parent / "04-outputs/unified_labeling/phase1_3_all_sources_labeled.jsonl"
    output_dir = Path(__file__).parent.parent.parent / "04-outputs/tag_gap_analysis"
