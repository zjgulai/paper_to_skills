...
def main():
    ...
    dict_path = base_dir / "04-outputs/tag_dictionary_v3.4_draft.xlsx"
    v30_path = base_dir / "03-data-assets/原种子标签/SGCS_标签字典_VOC标签大宽表V3.0_v1.xlsx"
    output_path = base_dir / "04-outputs/tag_dictionary_v3.4_filled.xlsx"
    ...
    audit_path = base_dir / "04-outputs/phase2_8_audit.json"
