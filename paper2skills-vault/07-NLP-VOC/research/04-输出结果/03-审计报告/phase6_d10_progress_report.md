...
一次修复后 3 个失败部门（客服部/国际物流部/电商运营部）全部通过。

### 2.3 部门 MAA 输出样本（Top-3）

| 部门 | 总话题 | Top-1 标签 | SRAC 分差 |
|---|---:|---|---:|
| 产品研发部 | 62 | 质量感知 (20,192 hits) | **5.35** ✅ |
| 客服部 | 36 | 服务满意 (10,173 hits) | **5.42** ✅ |
| 市场部 | 34 | — | **5.03** ✅ |
| 国际物流部 | 39 | — | **5.27** ✅ |
| 电商运营部 | 34 | — | **5.57** ✅ |
| 品控部 | 14 | — | **6.46** ✅ |
...
| 产品研发部首行 | "质量感知 TAG_GEN_E003 8.59" ✅ 与 MAA JSON 一致 |
...
点击 `产品研发部` tab 后：
- `tab-产品研发部` display=block ✅
- 其他 7 个 display=none ✅
- `tab-btn.active` 标记正确切换到 产品研发部
