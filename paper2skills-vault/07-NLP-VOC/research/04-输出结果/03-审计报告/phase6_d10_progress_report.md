...
一次修复后 3 个失败部门（全球客服中心/仓储物流部/电商运营部）全部通过。

### 2.3 部门 MAA 输出样本（Top-3）

| 部门 | 总话题 | Top-1 标签 | SRAC 分差 |
|---|---:|---|---:|
| 产品中心 | 62 | 质量感知 (20,192 hits) | **5.35** ✅ |
| 全球客服中心 | 36 | 服务满意 (10,173 hits) | **5.42** ✅ |
| 品牌市场中心 | 34 | — | **5.03** ✅ |
| 仓储物流部 | 39 | — | **5.27** ✅ |
| 电商运营部 | 34 | — | **5.57** ✅ |
| 品质管理中心 | 14 | — | **6.46** ✅ |
| 法务合规部 | 8 | 产品影响人身安全/健康状况 (646 hits) | **6.23** ✅ |
...
| SRAC 行 | **68**（7 部门 × 10 + 法务合规部 8）✅ |
| AGRS 分组 | **68**（全部 7 × 10 左右）✅ |
| 产品中心首行 | "质量感知 TAG_GEN_E003 8.59" ✅ 与 MAA JSON 一致 |
...
点击 `产品中心` tab 后：
- `tab-产品中心` display=block ✅
- 其他 7 个 display=none ✅
- `tab-btn.active` 标记正确切换到 产品中心
