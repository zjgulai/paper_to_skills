...
|---|---|---|---:|:---:|---|
| 1 | LLM Top-1 accuracy vs golden | `>= 0.85` | 0.7547 | ❌ FAIL | n_eval=481 |
| 2 | Per-label F1 weighted (TOP-30) | `>= 0.75` | 0.8312 | ✅ PASS |  |
| 3 | Top-3 mean Jaccard (recall proxy) | `>= 0.50` | 0.7343 | ✅ PASS |  |
...
| 7 | Proxy NPS three-way agreement vs golden | `>= 0.85` | 0.998 | ✅ PASS | n_eval=500 |
| 8 | Tag mutex (POS+NEG co-occurrence) rate | `< 0.03` | 0.0038 | ✅ PASS | violations=19, n=5000 |
| 9 | JSON parse failure rate | `< 0.01` | 0.0014 | ✅ PASS | failed=7, n=5000 |
