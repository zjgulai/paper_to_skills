...
**三轨验证**：
- **成本**：数据采集需接入独立站订单系统（约 0.5 人周），计算资源极低（单机 Python 脚本即可），人力成本约 ¥5000-8000。
- **合规**：独立站套餐定价无平台政策限制，但需注意避免虚假原价（如虚构"单品合计"价格），需符合 FTC 定价真实性要求。
- **风险**：套餐折扣过大可能引发用户对单品价值的质疑，导致单品销量下滑；若套餐价格低于成本线，可能被认定为倾销（尤其欧盟市场）。
