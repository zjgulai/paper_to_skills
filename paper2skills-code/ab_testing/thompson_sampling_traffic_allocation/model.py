"""
Skill: Skill-Thompson-Sampling-Traffic-Allocation
Domain: ab_testing
Title: Thompson Sampling Traffic Allocation — Thompson 采样流量分配
"""
import numpy as np
import pandas as pd
import warnings
    ...
    try:
        ...
        for k, v in result.items():
            if isinstance(v, dict):
                ...
                print(f"  {k}: {v}")
        print(f"[OK] Thompson-Sampling-Traffic-Allocation 测试通过")
