"""
Skill: Skill-Cross-Border-Payment-Fraud-Detection
Domain: risk_fraud
Title: Cross-Border Payment Fraud Detection — 跨境支付欺诈检测
"""
import numpy as np
import pandas as pd
import warnings
    ...
    try:
        ...
        for k, v in result.items():
            if isinstance(v, dict):
                ...
                print(f"  {k}: {v}")
        print(f"[OK] Cross-Border-Payment-Fraud-Detection 测试通过")
