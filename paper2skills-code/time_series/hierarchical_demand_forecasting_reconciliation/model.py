"""
Skill: Skill-Hierarchical-Demand-Forecasting-Reconciliation
Domain: time_series
Title: Hierarchical Demand Forecasting Reconciliation
"""
import numpy as np
import pandas as pd
import warnings
    ...
    try:
        ...
        for k, v in result.items():
            if isinstance(v, dict):
                ...
                print(f"  {k}: {v}")
        print(f"[OK] Hierarchical-Demand-Forecasting-Reconciliation 测试通过")
