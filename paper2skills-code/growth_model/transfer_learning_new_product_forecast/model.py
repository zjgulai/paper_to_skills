"""
Skill: Skill-Transfer-Learning-New-Product-Forecast
Domain: growth_model
Title: Transfer Learning New Product Sales Forecasting（迁移学习新品销量预测）
"""
import numpy as np
import pandas as pd
import warnings
    ...
    try:
        ...
        for k, v in result.items():
            if isinstance(v, dict):
                ...
                print(f"  {k}: {v}")
        print(f"[OK] Transfer-Learning-New-Product-Forecast 测试通过")
