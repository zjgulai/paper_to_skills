"""
Skill: Skill-GP-Tweedie-Intermittent-New-Product-Demand
Domain: growth_model
Title: GP-Tweedie Intermittent New Product Demand（GP+Tweedie 间歇稀疏新品需求预测）
"""
import numpy as np
import pandas as pd
import warnings
    ...
    try:
        ...
        for k, v in result.items():
            if isinstance(v, dict):
                ...
                print(f"  {k}: {v}")
        print(f"[OK] GP-Tweedie-Intermittent-New-Product-Demand 测试通过")
