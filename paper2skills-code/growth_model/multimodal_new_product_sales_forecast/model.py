"""
Skill: Skill-Multimodal-New-Product-Sales-Forecast
Domain: growth_model
Title: Multimodal New Product Sales Forecast（多模态外部信号新品销量预测）
"""
import numpy as np
import pandas as pd
import warnings
    ...
    try:
        ...
        for k, v in result.items():
            if isinstance(v, dict):
                ...
                print(f"  {k}: {v}")
        print(f"[OK] Multimodal-New-Product-Sales-Forecast 测试通过")
