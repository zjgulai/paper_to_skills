"""
Skill: Skill-Hierarchical-Search-Intent-Classification
Domain: advertising
Title: Hierarchical Search Intent Classification
"""
import numpy as np
import pandas as pd
import warnings
    ...
    try:
        ...
        for k, v in result.items():
            if isinstance(v, dict):
                ...
                print(f"  {k}: {v}")
        print(f"[OK] Hierarchical-Search-Intent-Classification 测试通过")
