"""
Skill: Skill-AGRS-Aspect-Guided-Review-Summarization
Domain: user_analytics
Title: AGRS Aspect Guided Review Summarization
"""
import numpy as np
import pandas as pd
import warnings
    ...
    try:
        ...
        for k, v in result.items():
            if isinstance(v, dict):
                ...
                print(f"  {k}: {v}")
        print(f"[OK] AGRS-Aspect-Guided-Review-Summarization 测试通过")
